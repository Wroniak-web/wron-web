...
// Импортируем парсеры
const parsePracuj = require('./pracuj');
const parseJustJoin = require('./justjoin');
const parseRocketJobs = require('./rocketjobs');
const parseGoogle = require('./google');
const parseAmazon = require('./amazon');
const parseNoFluffJobs = require('./nofluffjobs');
const parseLinkedIn = require('./linkedin');
const parseOlx = require('./olx');
...
async function parseAllSites() {
    console.log('🚀 Starting static parsing...');
    await ensureDataDir();
